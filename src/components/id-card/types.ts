...
export const DEFAULT_DESIGN: CardDesign = {
  ...
  elements: [
    ...
    { id: uid(), type: "text", label: "Teacher", x: 3.5, y: 53, w: 57, h: 6, content: "Teacher: {{teacherName}}", fontSize: 10, fontWeight: "600", color: "#334155", locked: false },
    { id: uid(), type: "text", label: "Subject", x: 3.5, y: 62, w: 57, h: 6, content: "Subject: {{subject}}", fontSize: 10, fontWeight: "600", color: "#334155", locked: false },
